...
if need_install 'zmq' 'libzmq.a'; then
  ...
  tar --no-same-owner -xzf zeromq-${libzmq_ver}.tar.gz
...
if need_install 'cppzmq' 'cppzmq*'; then
  ...
  tar --no-same-owner -xzf v${cppzmq_ver}.tar.gz
...
if need_install 'protobuf' 'libprotobuf*'; then 
  ...
  tar --no-same-owner -xzf protobuf-cpp-${protobuf_ver}.tar.gz
...
if need_install 'gflags' 'libgflags*'; then
  ...
  tar --no-same-owner -xzf v${gflags_ver}.tar.gz
...
if need_install 'glog' 'libglog*'; then
  ...
  tar --no-same-owner -xzf v${glog_ver}.tar.gz
...
if need_install 'rapidjson' 'rapidjson*'; then
  ...
  tar --no-same-owner -xzf v${rapidjson_ver}.tar.gz
